...
filename = "Eagle3take2/state_1/model.safetensors" # Replace your_file.safetensors with the actual file name
state_dict={}
...
x=(state_dict['layers.0.self_attn.v_proj.weight'])
import torch
print(torch.norm(x[:, :4096]))
print(torch.norm(x[:, 4096:]))



filename = "Eagle3take2/state_5/model.safetensors" # Replace your_file.safetensors with the actual file name
state_dict={}
...
# filename = "Eagle3take2/state_1/model_1.safetensors" # Replace your_file.safetensors with the actual file name
# f=load_file(filename)
# for key, tensor in f.items():
